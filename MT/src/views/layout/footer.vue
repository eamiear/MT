<template>
  <section id='foot_guide'>
    ...
    <section @click = "gotoAddress({path: '/design/' + geohash})" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('design') !== -1? '#findActive' : '#find'"></use>
      </svg>
      <span>设计师</span>
    </section>
    <section @click = "gotoAddress('/category')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('category') !== -1? '#orderActive' : '#order'"></use>
      </svg>
      <span>分类</span>
    </section>
    <section @click = "gotoAddress('/cart')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('cart') !== -1? '#orderActive' : '#order'"></use>
      </svg>
      <span>购物车</span>
    </section>
